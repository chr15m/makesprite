...
(defn component:settings [state]
  (let [openai-key (get-in @state [:settings :openai-key])]
    [:<>
     ...
     [:p
      "Current law around images generated by GPTs is unresolved. "
      "Recent rulings in some jurisdictions indicate that generated"
      " content must be considered " [:strong "public domain"] "."
      " This means it is likely you do not have exclusive rights to"
      " generated content." " In addition, future rulings may call into"
      " question the legality of generated content due to the way"
      " GPT image generators have been trained."]
     [:h3 "Export"]
     [:button
